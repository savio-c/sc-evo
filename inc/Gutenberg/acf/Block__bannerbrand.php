...
add_action('acf/init', 'acf_init_Banner_brand');
function acf_init_Banner_brand() {

	if( function_exists('acf_register_block_type') ) {

		acf_register_block_type( array(
			'name'				    =>  'bannerBrand',
			'title'				    =>  __('APX - Banner Brand'),
			'description'		  =>  __('Banner Brand'),
			'render_callback'	=>  'bannerbrand_callback',
			'category'			  =>  'layout',
...
function bannerbrand_callback( $block ) {
